...
<dd>function</dd>
<dt>Source</dt>
<dd>src/native/include/helios/CXNetwork.h:843</dd>
</dl>
...
```text
CX_EXTERN CXConnectedComponentsPhase CXConnectedComponentsSessionStep( CXConnectedComponentsSessionRef session, CXSize budget );
```
